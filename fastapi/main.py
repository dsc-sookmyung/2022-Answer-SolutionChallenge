    ...
    for date in matched_dates:
        ...
        if not matched_events.get(matched_event):
            ...
            if len(date.group()) < 8: # MM월 DD일 or MM.DD
                ...
                if "년" in date.group(): # YYYY년 MM월 DD일 or YYYY.MM.DD
