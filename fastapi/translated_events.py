event_list_kr = ["졸업", "수료식", "폐회식", "개회식", "입학식", "입학식", "졸업식", "졸업식",
                 ...
                 "운동회", "탐색", "민방위", "소방훈련", "축제"]
event_list_en = ["graduation", "commencement", "closing ceremony", "opening ceremony", "entrance ceremony", "admission ceremony", "diploma award ceremony", "graduation ceremony",
...
event_list_th = ["จบการศึกษา", "เริ่มต้น", "พิธีปิด", "พิธีเปิด", "พิธีเข้า", "พิธีรับเข้าเรียน", "พิธีมอบประกาศนียบัตร", "พิธีสำเร็จการศึกษา",
...
event_list_km = ["បញ្ចប់ការសិក្សា", "ចាប់ផ្តើម", "ពិធីបិទ", "ពិធីបើក", "ពិធីចូល", "ពិធីចូលរៀន", "ពិធីប្រគល់សញ្ញាបត្រ", "ពិធីបញ្ចប់ការសិក្សា",
...
event_list_vi = ["tốt nghiệp", "bắt đầu", "lễ bế giảng", "lễ khai giảng", "lễ nhập học", "lễ nhập học", "lễ trao bằng tốt nghiệp", "lễ tốt nghiệp",
...
event_list_ja = ["卒業", "開始", "閉会式", "開会式", "入場式", "入学式", "卒業証書授与式", "卒業式",
